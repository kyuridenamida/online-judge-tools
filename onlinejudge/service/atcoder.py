...
class AtCoderContest(object):
    ...
    get_start_time = utils.getter_with_load_details('_start_time')  # type: Callable[..., datetime.datetime]
    get_duration = utils.getter_with_load_details('_duration')  # type: Callable[..., datetime.timedelta]
    get_rated_range = utils.getter_with_load_details('_rated_range')  # type: Callable[..., str]
    get_can_participate = utils.getter_with_load_details('_can_participate')  # type: Callable[..., str]
    get_penalty = utils.getter_with_load_details('_penalty')  # type: Callable[..., datetime.timedelta]
